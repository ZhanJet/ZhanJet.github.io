...
I am interested in applying advanced control techniques to robots that are not only able to interact with the environment under various uncertainties, but also more collaborative with humans. Now, I am mainly working on developing adaptive control on mobile-manipulators for efficient human-robot collaboration to improve the working efficiency in factories.
